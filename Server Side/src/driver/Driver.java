...
public class Driver {
	...
	public static void main(String[] args) {
		DefaultServerSocket server = new DefaultServerSocket(6666);
		server.run();
		...
		String [] x =  {"Color", "Fort Knox Gold Clearcoat Metallic", "Red"}; //input for operation 0
		String [] x1 = {"Color", "Fort Knox Gold Clearcoat Metallic", "Yellow"}; //input for operation 0
		
		//a1.editThread("Ford Wagon ZTW", 0, x);
		//a1.editThread("Ford Wagon ZTW", 1, x1);
		
		a1.editThread("Ford Wagon ZTW", 2, x);
		a1.editThread("Ford Wagon ZTW", 3, x1);
		*/
